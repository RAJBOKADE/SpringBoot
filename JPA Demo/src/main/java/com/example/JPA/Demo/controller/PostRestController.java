...
public class PostRestController {
    ...
    public ResponseEntity<PostResponse> updatePost(@PathVariable Long id, @RequestBody PostResponse postRespoonse) {
        PostResponse updatePostRespoonse = postService.updatePost(id, postRespoonse);
